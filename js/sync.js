...
// canEditPlayerPrivate/buildSharedExportPayload/getDiceRollerName still live in
// app.js as of this phase of the module split (they move to their own modules in
// later phases). This creates an intentional circular import with app.js, which
// itself imports from this module. That's safe here because every one of these
// names is only ever referenced inside a function body (never at module-eval
// time), so by the time any of them actually runs, both modules have finished
// loading. Update this import (and drop the circularity) as each function moves
// to its own module in a later phase.
import {
